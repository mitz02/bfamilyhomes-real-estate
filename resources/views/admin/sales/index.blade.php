...
<div class="mb-8">
    <div class="flex items-center gap-2 text-xs md:text-sm text-gray-500 mb-4 px-2 md:px-0">
        ...
        <span class="text-orange-600 font-semibold">Sales History</span>
    </div>
    ...
    <div class="relative bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 rounded-2xl p-6 md:p-8 shadow-lg overflow-hidden">
        ...
        <div class="relative flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div class="flex items-start gap-4">
                ...
                <div>
                    <h1 class="text-xl md:text-2xl font-bold text-white">Sales History</h1>
...
<!-- Stats -->
<div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6 px-1 md:px-0">
    ...
    <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-4">
        <p class="text-xs text-gray-500 mb-1">Record Sale</p>
        <a href="{{ route('admin.sales.create') }}" class="text-sm font-semibold text-orange-600 hover:text-orange-700 inline-flex items-center gap-1">
...
<div class="bg-white rounded-xl border border-gray-100 shadow-sm p-4 mb-6">
    <form method="GET" class="flex flex-wrap gap-3">
        ...
        <a href="{{ route('admin.sales') }}" class="px-4 py-2 bg-gray-100 text-gray-500 rounded-lg hover:bg-gray-200 text-sm transition-colors">
            Clear
        </a>
        @endif
    </form>
